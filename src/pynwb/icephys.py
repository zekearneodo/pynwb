...
class PatchClampSeries(TimeSeries):
    ...
    @docval({'name': 'name', 'type': str, 'doc': 'The name of this TimeSeries dataset'},
            {'name': 'source', 'type': str, 'doc': ('Name of TimeSeries or Modules that serve as the source for the data '
                                                   ...
                                                   'acquisition data')},
            {'name': 'data', 'type': (list, np.ndarray, TimeSeries, Iterable, DataIO), 'doc': 'The data this TimeSeries dataset stores. Can also store binary data e.g. image frames'},
            ...
            {'name': 'timestamps', 'type': (list, np.ndarray, TimeSeries, Iterable, DataIO), 'doc': 'Timestamps for samples stored in data', 'default': None},
